...
| 38 | El botón de WhatsApp pasa a la **izquierda** | Retell se ancla abajo a la derecha con `z-index: 999999` y su burbuja de aviso usa `bottom: 90px` en móvil. Apilar el FAB arriba lo dejaría tapado igual; a la izquierda ambos quedan en la zona del pulgar sin pisarse | 2026-08-04 |
